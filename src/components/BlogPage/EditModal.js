...
const EditModal = (props) => {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>  
        <h2 className="cols__main-title cols__main-title--top"className='container'>PLEASE READ THESE TERMS AND CONDITIONS OF USE CAREFULLY BEFORE USING THIS SITE.</h2><br/>
        <p className="p1"className='container'>By using this site, you signify your assent to these Terms and Conditions. If you do not agree to all of these Terms and Conditions, do not use this site!<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Liability of All-cures.com and Its Licensors</h2>
<p className="p1"className='container'>The use of the All-cures.com Site and the Content is at your own risk.<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>User Content and Submissions</h2>
<p className="p1"className='container'>The personal information you submit to AllCures-Info.com is governed by the All-cures.com Privacy Policy. To the extent there is an inconsistency between this Agreement and the All-cures.com Privacy Policy, this Agreement shall govern.<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Complete Agreement</h2>
<p className="p1"className='container'>Except as expressly provided in a particular "legal notice" on the All-cures.com Site, these Terms and Conditions and the All-cures.com Privacy Policy constitute the entire agreement between you and All-cures.com with respect to the use of the All-cures.com Site, and Content.
</p><br/>
<h2 className="cols__main-title cols__main-title--top"className='container'>Thank you for your cooperation. We hope you find the All-cures.com Site helpful and convenient to use! </h2>
      ...
      >
        ...
        <Modal.Body>  
        <h2 className="cols__main-title cols__main-title--top"className='container'>Introduction</h2>

<p className="p1"className='container'>
...
<h2 className="cols__main-title cols__main-title--top" className='container'>Definitions</h2>

<p className="p1" className='container' >SERVICE means <a href="https://www.all-cures.com">www.all-cures.com </a>
...
<h2 className="cols__main-title cols__main-title--top"className='container' >Information Collection and Use</h2>
<p className="p1"className='container' >We collect several different types of information for various purposes to provide and improve our Service to you.</p><br/>

<h2 className="cols__main-title cols__main-title--top"className='container'>Types of Data Collected</h2>
<p className='p1'className='container'><b>Personal Data</b><br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Transfer of Data</h2>
<p className='p1'className='container'>We will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies</p><br/>
<h2 className="cols__main-title cols__main-title--top"className='container'>Disclosure of Data</h2>
<p className='p1'className='container'>We may disclose personal information that we collect, or you provide.</p><br/>
<h2 className="cols__main-title cols__main-title--top"className='container'>Disclosure for Law Enforcement.</h2>
<p className="p1"className='container'>Under certain circumstances, we may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities.</p><br/>
<h2 className="cols__main-title cols__main-title--top"className='container'>Business Transaction.</h2>
<p className="p1"className='container'>If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Service Providers</h2>
<p className="p1"className='container' >We may employ third party companies and individuals to facilitate our Service (“Service Providers”), provide Service on our behalf, perform Service-related services or assist us in analyzing how our Service is used.<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Analytics</h2>
<p className="p1"className='container'>We may use third-party Service Providers to monitor and analyze the use of our Service.<br/>
Google Analytics<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Changes to This Privacy Policy</h2>
<p className="p1"className='container'>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.<br/>
...
<h2 className="cols__main-title cols__main-title--top"className='container'>Contact Us</h2>
<p className='p1'className='container'>If you have any questions about this Privacy Policy, please contact us:<br/>

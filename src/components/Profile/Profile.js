        ...
        return(
            <div>
                ...
                <section className="Profileleft">
                    <div className="container">
                        ...
                        <div className="col-md-8 pd-0">
                            ...
                            <div className="abt-address">
                                ...
                                <div className="col-md-6">
                                    <div className="map">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3781.598439251183!2d73.72995831436974!3d18.592134071835297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bbc3bc58288d%3A0x93c746b34d487608!2sThe%20Digital%20Group%20Infotech!5e0!3m2!1sen!2sin!4v1603163746315!5m2!1sen!2sin" width="300" height="168.75px" frameborder="0" style={{border:0}} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                    </div>
                                </div>
                                <div className="col-md-6">
                            ...
                            <div className="tab-nav">
                                ...
                                {/* <!-- Nav tabs --> */}
                                <ul className="nav">
                                <li className="active"><a data-toggle="pill" href="#patient">Patient Reviews (123)</a></li>
                                <li><a data-toggle="pill" href="#recomended">Recommendations</a></li>
                                </ul>
                            </div>
                            <div className="tab-content">
                                <div id="patient" className="tab-pane fade in active">
                                <div className="rating-outer" id="rating">
                                    <div className="rating-patient">
                                    <div className="rating-patient-grid clearfix">
                                        <div className="paitent-profile"> <img src={ClientA}alt="ClientA"/> </div>
                                    ...
                                    <div className="back-top"> <a href="#rating">
                                        <p><i className="fa fa-angle-up" aria-hidden="true"></i> Back to Top</p>
                                        </a> </div>
                                    <a href="javascript:void(0)" className="read-more-rating">Read more Reviews</a> </div>
                                    <div className="faqs" id="faq">
                                    <div className="faqs-wrap">
                                        <div className="question">
                                        <h2>How soon can I make an appointment with Dr. Jordan Reich?</h2>
                                        <p>Generally, Dr. Jordan Reich has appointments available on Zocdoc within 1 week. You can see Dr. Sanghi's earliest availability on Zocdoc and <a href="#">Make an appointment online.</a></p>
                                        </div>
                                        <div className="question">
                                        <h2>Is Dr. Jordan Reich accepting new patients?</h2>
                                        <p>Dr. Pramod Sanghi generally accepts new patients on Zocdoc. You can see Dr. Reich's earliest availability on Zocdoc and <a href="#">Schedule an appointment online.</a></p>
                                        </div>
                                        <div className="question">
                                        <h2>Does Dr. Jordan reich accept my insurance?</h2>
                                        <p><a href="#">Choose your insurance plan</a> to verify if Dr. Jordan Reich is in-network.</p>
                                        </div>
                                        <div className="question">
                                        <h2>Can I make an appointment with Dr. Jordan Reich online?</h2>
                                        <p>Yes, you can <a href="#">Make an appointment online.</a> with Dr. Reich using Zocdoc. It’s simple, secure, and free.</p>
                                        </div>
                                    </div>
                                    </div>
                                    <div className="rating-footer">
                                    <div className="back-top"> <a href="#faq">
                                        <p><i className="fa fa-angle-up" aria-hidden="true"></i> Back to Top</p>
                                        </a> </div>
                                    <a href="javascript:void(0)" className="read-more-rating">Read more Reviews</a> </div>
                                </div>
                        ...
                        <div className="col-md-4 pdr-0">
                            ...
                            <div className="form-group">
                                ...
                                <select className="form-control">
                                <option>110 West 14th Street, New York, NY, 10011</option>
                                <option>110 West 14th Street, New York, NY, 10011</option>
                                <option>110 West 14th Street, New York, NY, 10011</option>
                                </select>
                            </div>
                            <div className="detail-r">
                                ...
                                <p>Mon</p>
                                <li><a href="javascript:void(0)" className="active">9.00 am</a></li>
                            ...
                            <a href="javascript:void(0)" className="btn-bg profile-btn color-white">Appointment</a> 
                            <a href="javascript:void(0)" className="bg-gray video-btn color-light-gray">Video Consult</a> </div>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                        <div className=""> <a href="javascript:void(0)"> <span className="icon-chatbot"><span className="path1"></span><span className="path2"></span><span className="path3"></span><span className="path4"></span><span className="path5"></span><span className="path6"></span><span className="path7"></span><span className="path8"></span><span className="path9"></span><span className="path10"></span><span className="path11"></span><span className="path12"></span><span className="path13"></span><span className="path14"></span><span className="path15"></span><span className="path16"></span><span className="path17"></span><span className="path18"></span><span className="path19"></span></span> </a> </div>
                        </div>
                    </div>
                 </section>
             <Footer/>
